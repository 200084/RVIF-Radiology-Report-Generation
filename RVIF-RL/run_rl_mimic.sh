...
mkdir -p results/mimic_cxr-Vencode/base_cmn_rl/
mkdir -p records/mimic_cxr-Vencode/base_cmn_rl/
...
--batch_size 6 \
--epochs 50 \
--save_dir results/mimic_cxr-Vencode/base_cmn_rl-ablation/ \
--record_dir records/mimic_cxr-Vencode/base_cmn_rl-ablation/ \
--step_size 1 \
--gamma 0.8 \
--seed ${seed} \
--topk 32 \
--sc_eval_period 3000 \
--resume results/mimic_cxr-Vencode/base_seed_${seed0}/current_checkpoint26-best.pth
