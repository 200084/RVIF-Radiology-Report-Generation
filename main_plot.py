...
def parse_agrs():
    ...
    # Data input settings
    parser.add_argument('--image_dir', type=str, default='/home/liyaw22/R2GenCMN/data/iu_xray/images/',
                        help='the path to the directory containing the data.')
    parser.add_argument('--ann_path', type=str, default='/home/liyaw22/R2GenCMN/data/iu_xray/annotation.json',
                        help='the path to the directory containing the data.')
